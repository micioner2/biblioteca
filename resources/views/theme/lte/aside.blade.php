          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{asset("assets/$theme/}index.html")}}index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="{{asset("assets/$theme/index2.html")}}index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
